                                        ...
                                        <div class="col-md-12">
                                            <form class="form" action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('kegiatan') ? 'is-invalid' : '' ?>" value="<?php echo $BidangC->nama_kegiatan; ?>" placeholder="Nama Kegiatan" name="kegiatan">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('tempat') ? 'is-invalid' : '' ?>" value="<?php echo $BidangC->tempat_pelaksanaan; ?>" placeholder="Tempat Pelaksanaan" name="tempat">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <?php
                                                        $cls_date = new DateTime($BidangC->waktu_pelaksanaan);
                                                        $newDate = $cls_date->format('l, d F, Y');
                                                        ?>
                                                        <input type='text' class="form-control pickadate-format <?php echo form_error('tgl_pelaksanaan') ? 'is-invalid' : '' ?>" value="<?php echo $newDate; ?>" placeholder="Basic Pick-a-date" name="tgl_pelaksanaan" id="tgl_pelaksanaan" />
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('komunitas') ? 'is-invalid' : '' ?>" value="<?php echo $BidangC->nama_komunitas; ?>" placeholder="Nama Komunitas" name="komunitas">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('judul_materi') ? 'is-invalid' : '' ?>" value="<?php echo $BidangC->judul_materi; ?>" placeholder="Judul Materi" name="judul_materi">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control <?php echo form_error('jml_peserta') ? 'is-invalid' : '' ?>" value="<?php echo $BidangC->jumlah_peserta; ?>" placeholder="Jumlah Peserta" name="jml_peserta">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-actions">
                                                    <a href="<?php echo site_url('BidangC/edit') ?>" type="button" class="btn btn-danger mr-1">
