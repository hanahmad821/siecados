                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <form class="form" action="<?php echo base_url(); ?>BidangA/add" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <select id="kode_matkul" name="kode_matkul" class="form-control <?php echo form_error('kode_matkul') ? 'is-invalid' : '' ?>">
                                                        ...
                                                        <?php foreach ($matkul as $row) : ?>
                                                            <option value="<?php echo $row->kode_matkul; ?>"><?php echo $row->kode_matkul . " - " . $row->nama_matkul; ?> </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="kelas">Kelas</label>
                                                    <input type="text" class="form-control <?php echo form_error('kelas') ? 'is-invalid' : '' ?>" placeholder="Kelas" name="kelas">
                                                </div>
                                                <div class="form-group">
                                                    <label for="sks">Jumlah SKS</label>
                                                    <input type="number" class="form-control <?php echo form_error('sks') ? 'is-invalid' : '' ?>" placeholder="SKS" name="sks">
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
