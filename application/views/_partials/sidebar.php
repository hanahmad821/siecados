...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true" data-img="<?php echo base_url();?>app-assets/images/backgrounds/04.jpg">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row position-relative">
          <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url();?>home"><img class="brand-logo" alt="Chameleon admin logo" src="<?php echo base_url();?>app-assets/images/logo/logo-binus.png"/>
              <h3 class="brand-text">Catur Dharma</h3></a></li>
