                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <a href="<?php echo base_url();?>#">Apple</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <a href="<?php echo base_url();?>#">Nike</a>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-truncate">
                                        <a href="<?php echo base_url();?>#">Rolex</a>
                                    </td>
                                    <td>
                            ...
                            <ul class="list-unstyled base-timeline activity-timeline">
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="<?php echo base_url();?>#" class="text-danger">Delivered</a>
                                    </div>
                                ...
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="<?php echo base_url();?>#" class="text-primary">In Transit</a>
                                    </div>
                                    <small class="text-muted">
                                        23 hours ago
                                    </small>
                                ...
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="<?php echo base_url();?>#" class="text-dark">Dispatched</a>
                                    </div>
                                    <small class="text-muted">
                                        4 days ago
                                    </small>
                                ...
                                <li class="">
                                    ...
                                    <div class="base-timeline-info">
                                        <a href="<?php echo base_url();?>#" class="text-warning">Order Received</a>
                                    </div>
                                    <small class="text-muted">
                                        5 days ago
                                    </small>
            ...
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <ul class="list-inline mb-0">
                        <li>
                            <a class="btn btn-sm btn-danger box-shadow-2 round btn-min-width pull-right" href="<?php echo base_url();?>#">New Task</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <tbody>
                                    ...
                                    <td class="text-truncate border-0">
                                        <ul class="list-unstyled users-list m-0 text-right">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="John Doe" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-19.png" alt="Avatar">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Katherine Nichols" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-18.png" alt="Avatar">
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-truncate border-0">
                                        <ul class="list-unstyled users-list m-0 text-right">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="John Doe" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-15.png" alt="Avatar">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Joseph Weaver" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-14.png" alt="Avatar">
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-truncate border-0">
                                        <ul class="list-unstyled users-list m-0 text-right">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="John Doe" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-11.png" alt="Avatar">
                                            </li>
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Katherine Nichols" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-12.png" alt="Avatar">
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-truncate border-0">
                                        <ul class="list-unstyled users-list m-0 text-right">
                                            <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Joseph Weaver" class="avatar avatar-sm pull-up">
                                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-10.png" alt="Avatar">
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                ...
                <div id="carousel-area" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="<?php echo base_url();?>app-assets/images/carousel/08.jpg" class="d-block w-100" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img src="<?php echo base_url();?>app-assets/images/carousel/03.jpg" class="d-block w-100" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="<?php echo base_url();?>app-assets/images/carousel/01.jpg" class="d-block w-100" alt="Third slide">
                        </div>
                    </div>
                    <a class="carousel-control-prev" href="<?php echo base_url();?>#carousel-area" role="button" data-slide="prev">
                            <span class="la la-angle-left" aria-hidden="true"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                    <a class="carousel-control-next" href="<?php echo base_url();?>#carousel-area" role="button" data-slide="next">
                            <span class="la la-angle-right icon-next" aria-hidden="true"></span>
                            <span class="sr-only">Next</span>
                        </a>
                </div>
                <div class="card-body">
                    <a href="<?php echo base_url();?>#" class="card-link">Card link</a>
                    <a href="<?php echo base_url();?>#" class="card-link">Another link</a>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div id="recent-buyers" class="media-list">
                    <a href="<?php echo base_url();?>#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-7.png" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                            ...
                            <ul class="list-unstyled users-list m-0 float-right">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 1" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-1.jpg"
                                        alt="Avatar">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-2.jpg"
                                        alt="Avatar">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 3" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-4.jpg"
                                        alt="Avatar">
                                </li>
                            </ul>
                    ...
                    <a href="<?php echo base_url();?>#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-away">
                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-8.png" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                            ...
                            <ul class="list-unstyled users-list m-0 float-right">
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 1" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-5.jpg"
                                        alt="Avatar">
                                </li>
                                <li data-toggle="tooltip" data-popup="tooltip-custom" data-original-title="Product 2" class="avatar avatar-sm pull-up">
                                    <img class="media-object rounded-circle no-border-top-radius no-border-bottom-radius" src="<?php echo base_url();?>app-assets/images/portfolio/portfolio-6.jpg"
                                        alt="Avatar">
                                </li>
                            </ul>
                            <p class="list-group-item-text mb-0">
                    ...
                    <a href="<?php echo base_url();?>#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-busy">
                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-9.png" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                    ...
                    <a href="<?php echo base_url();?>#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-10.png" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
                    ...
                    <a href="<?php echo base_url();?>#" class="media border-0">
                        <div class="media-left pr-1">
                            <span class="avatar avatar-md avatar-online">
                                <img class="media-object rounded-circle" src="<?php echo base_url();?>app-assets/images/portrait/small/avatar-s-11.png" alt="Generic placeholder image">
                                <i></i>
                            </span>
                        </div>
                        <div class="media-body w-100">
...
<!--/ Statistics -->
    ...
    <script src="<?php echo base_url();?>app-assets/vendors/js/charts/chartist.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>app-assets/vendors/js/charts/chartist-plugin-tooltip.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>app-assets/vendors/js/timeline/horizontal-timeline.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>app-assets/vendors/js/extensions/dropzone.min.js" type="text/javascript"></script>
