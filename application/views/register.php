            ...
            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                ...
                <div class="card-content">
                    ...
                    <div class="text-center">
                        <a href="<?php echo base_url();?>#" class="btn btn-social-icon round mr-1 mb-1 btn-facebook">
                            <span class="ft-facebook"></span>
                        </a>
                        <a href="<?php echo base_url();?>#" class="btn btn-social-icon round mr-1 mb-1 btn-twitter">
                            <span class="ft-twitter"></span>
                        </a>
                        <a href="<?php echo base_url();?>#" class="btn btn-social-icon round mr-1 mb-1 btn-instagram">
                    ...
                    <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1">
                        <span>Already a member ?
                            <a href="<?php echo base_url();?>login.php" class="card-link">Sign In</a>
                        </span>
                    </p>
                </div>
            </div>
