                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <!-- <form class="form" action="<?php echo base_url(); ?>BidangB/add" method="post"> -->
                                            <div class="form-body">
                                                ...
                                                <div id="nas-journal" style="display: none;">
                                                    <form class="form" action="<?php echo base_url(); ?>BidangB/add_journal" method="post">
                                                        ...
                                                        <div class="file-repeater" id="author22" style="display: none;">
                                                            <div data-repeater-list="repeater-list">
                                                                <div data-repeater-item style="background-color: #f2f2f2; margin-bottom:20px">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                ...
                                                <div id="int-con" style="display: none;">
                                                    <form class="form" action="<?php echo base_url(); ?>BidangB/add_conference" method="post">
                                                        ...
                                                        <div class="file-repeater" id="author23" style="display: none;">
                                                            <div data-repeater-list="repeater-list">
                                                                <div data-repeater-item style="background-color: #f2f2f2; margin-bottom:20px">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 mb-1">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input id="picker_from" class="form-control datepicker" type="date" placeholder="start date">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input id="picker_to" class="form-control datepicker" type="date" placeholder="start date">
                                                                    </div>
                                                                </div>
                                                            </div>
