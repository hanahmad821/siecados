                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <form class="form" action="<?php echo base_url(); ?>NasJurnal/add" method="post" enctype="multipart/form-data">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control  <?php echo form_error('indeks') ? 'is-invalid' : '' ?>" type="text" placeholder="Sinta 1 - Sinta 4" name="indeks">
                                                        <div class="invalid-feedback">
