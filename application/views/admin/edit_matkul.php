                                    ...
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <form class="form" action="" method="post">
                                                <input type="text" name="id_matkul" value="<?php echo $matkul->id_matkul ?>" hidden = "hidden"/>

                                                <div class="form-group">
                                                    <label for="kode_matkul">Kode Mata Kuliah</label>
                                                    <input type="text" class="form-control <?php echo form_error('kode_matkul') ? 'is-invalid' : '' ?>" placeholder="Kode Mata Kuliah" name="kode_matkul" value="<?php echo $matkul->kode_matkul ?>">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('nama_matkul') ? 'is-invalid' : '' ?>" placeholder="Nama Mata Kuliah" name="nama_matkul" value="<?php echo $matkul->nama_matkul ?>">
                                                </div>
                                                <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" class="form-control <?php echo form_error('sks') ? 'is-invalid' : '' ?>" placeholder="SKS" name="sks" value="<?php echo $matkul->sks ?>">
                                                </div>
                                                <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <?php if ($matkul->aktif == 1) : ?>
                                                            <fieldset>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status_matkul" id="status_matkul-yes" value="1" checked> Aktif</label>
                                                            </fieldset>
                                                            <fieldset>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status_matkul" id="status_matkul-no" value="0"> Non Aktif</label>
                                                            </fieldset>
                                                        <?php else : ?>
                                                            <fieldset>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status_matkul" id="status_matkul-yes" value="1"> Aktif</label>
                                                            </fieldset>
                                                            <fieldset>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="status_matkul" id="status_matkul-no" value="0" checked> Non Aktif</label>
                                                            </fieldset>
                                                        <?php endif; ?>

                                                    </div>
                                                    <div class="form-actions">
                                                        <a href="<?php echo site_url('admin/matkul/') ?>" type="button" class="btn btn-danger mr-1">
