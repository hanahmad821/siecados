                                        ...
                                        <div class="col-md-12">
                                            <form class="form" action="<?php echo base_url(); ?>admin/User/add" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('kode_dosen') ? 'is-invalid' : '' ?>" placeholder="Kode Dosen" name="kode_dosen">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('nama_dosen') ? 'is-invalid' : '' ?>" placeholder="Nama Dosen" name="nama_dosen">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="profil" name="profil" class="form-control">
                                                        ...
                                                        <?php foreach ($profil as $dosen) { ?>
                                                            <option value="<?php echo $dosen->id_profil; ?>"><?php echo $dosen->nama_profil; ?> </option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('jurusan') ? 'is-invalid' : '' ?>" placeholder="Jurusan" name="jurusan">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('no_hp') ? 'is-invalid' : '' ?>" placeholder="No HP" name="no_hp">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control <?php echo form_error('email') ? 'is-invalid' : '' ?>" placeholder="Email" name="email">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control <?php echo form_error('kode_kelompok_rumpun_ilmu') ? 'is-invalid' : '' ?>" placeholder="Kode Kelompok Rumpun Ilmu" name="kode_kelompok_rumpun_ilmu">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control <?php echo form_error('kode_rumpun_ilmu') ? 'is-invalid' : '' ?>" placeholder="Kode Rumpun Ilmu" name="kode_rumpun_ilmu">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="tipe_dosen" name="tipe_dosen" class="form-control">
                                                        ...
                                                        <option value="Subject Content Coordinator">Subject Content Coordinator </option>
                                                        <option value="Subject Content Specialist">Subject Content Specialist </option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="rentang_fm" name="rentang_fm" class="form-control">
                                                        ...
                                                        <option value="FM SCS">FM SCS </option>
                                                        <option value="FM STR">FM STR </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label for="jja">JJA</label>
                                                    <input type="text" class="form-control <?php echo form_error('jja') ? 'is-invalid' : '' ?>" placeholder="JJA" name="jja">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('password') ? 'is-invalid' : '' ?>" placeholder="Password" name="password">
                                                    <div class="invalid-feedback">
                                                        <?php echo form_error('password') ?>
                                                    </div>
                                                </div>
                                                <div class="form-actions">
                                                    <a href="<?php echo site_url('admin/user/add') ?>" type="button" class="btn btn-danger mr-1">
