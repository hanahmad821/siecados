                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <form class="form" action="<?php echo base_url(); ?>admin/matkul/add" method="post">
                                                <div class="form-group">
                                                    <label for="kode_matkul">Kode Mata Kuliah</label>
                                                    <input type="text" class="form-control <?php echo form_error('kode_matkul') ? 'is-invalid' : '' ?>" placeholder="Kode Mata Kuliah" name="kode_matkul">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control <?php echo form_error('nama_matkul') ? 'is-invalid' : '' ?>" placeholder="Nama Mata Kuliah" name="nama_matkul">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" class="form-control <?php echo form_error('sks') ? 'is-invalid' : '' ?>" placeholder="SKS" name="sks">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-actions">
                                                    <a href="<?php echo site_url('admin/matkul/add') ?>" type="button" class="btn btn-danger mr-1">
